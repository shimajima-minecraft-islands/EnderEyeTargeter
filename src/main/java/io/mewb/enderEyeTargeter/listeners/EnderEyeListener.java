    ...
    public void onEntitySpawn(EntitySpawnEvent event) {
        ...
        if (event.getEntity() instanceof EnderSignal) {
            ...
            if (customTarget != null && customTarget.getWorld() != null) {
                ...
                // Removed: eye.setDespawnTimer(Integer.MAX_VALUE);
                // This ensures the Ender Eye retains its normal despawn behavior (breaking after a few throws or reaching target).
